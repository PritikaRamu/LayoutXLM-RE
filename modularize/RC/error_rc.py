...
from preprocess_funsd import create_dataset
import pdb
import json
...
anno_path = '/home/pritika/testing_data/annotations'
image_path = '/home/pritika/testing_data/images'
test_dataset = create_dataset(anno_path, image_path)
...
model = LayoutLMv2ForRelationExtraction.from_pretrained('/home/pritika/layoutXLM/modularize/RC/checkpoints3/checkpt-28')
model.to(device)

model_eval(model,test_dataloader)

error_file = open("error_rc_funsd.json",'w')
